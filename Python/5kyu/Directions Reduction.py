...
# going north and coming back right away. What a waste of time! Better to do nothing.
#
...
# path is reduced to nothing. The Rust version takes a slice of enum Direction
