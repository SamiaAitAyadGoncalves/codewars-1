...
#
# This kata is part of a series on the Morse code. After you solve
# this kata, you may move to the next one.
#
...
# for errors and exceptions. In C#, tests will fail if the solution code
# throws an exception, please keep that in mind. This is mostly because
# otherwise the engine would simply ignore the tests, resulting
# in a "valid" solution.
#
# Good luck!
#
