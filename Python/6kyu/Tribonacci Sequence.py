...
# you may be tempted to think that we would get the same sequence shifted by
...
# number; if n == 0, then return an empty array and be ready for anything
# else which is not clearly specified ;)
#
# If you enjoyed this kata more advanced and generalized version of it can
# be found in the Xbonacci kata
#
