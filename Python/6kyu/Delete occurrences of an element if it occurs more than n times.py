...
# usually repeats. He isn't fond of seeing the Eiffel tower 40 times. He
# tells them that he will only sit during the session if they show the
# same motive at most N times. Luckily, Alice and Bob are able to encode
# the motive as a number. Can you help them to remove numbers such that
...
# EnoughIsEnough.deleteNth(new int[] {1,1,3,3,7,2,2,2,2}, 3) // return
# [1, 1, 3, 3, 7, 2, 2, 2]
#
# c++
# deleteNth({20,37,20,21}, 1) // return {20,37,21}
