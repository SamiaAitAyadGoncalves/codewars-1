...
# phrase or sentence and make a password by extracting the first letter
# of each word.
#
...
def make_password(phrase):
    ...
    return result.replace('i', '1').replace('I', '1').replace('o', '0').replace('O', '0').replace('s', '5').replace('S', '5')
