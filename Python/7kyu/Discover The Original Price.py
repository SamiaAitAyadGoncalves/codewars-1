...
# the return type must be of type decimal and the number must be
...
# the function should return the original price of that item
# before applying the sale percentage, which is ($100.00) of course,
# rounded to two decimal places.
#
# DiscoverOriginalPrice(75, 25) => 100.00M where 75 is
# the sale price (discounted price), 25 is the sale percentage
# and 100 is the original price
